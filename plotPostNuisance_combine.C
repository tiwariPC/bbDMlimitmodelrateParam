...
void plotPostNuisance_combine(TString mlfit="fitDiagnostics_2b_2017_fit_CRonly_result_Scaled_tt_1p2.root", TString outdir="plots_limit/pulls/", 
  ...
  //c->SaveAs(outdir+"/pulls_cronly"+postfix+".root");
    ...
    for (int i =1 ; i < numberOfCanvas+1 ; i++)
        ...
        c->Update();
        c->Modified();
	c->SaveAs(outdir+"/pulls_cronly"+postfix+"_"+postfix_2+".pdf");
  	c->SaveAs(outdir+"/pulls_cronly"+postfix+"_"+postfix_2+".png");
        c->SaveAs(outdir+"/pulls_cronly"+postfix+"_"+postfix_2+".C");
        c->SaveAs(outdir+"/pulls_cronly"+postfix+"_"+postfix_2+".root");
  }
